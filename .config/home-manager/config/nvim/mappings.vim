...
nnoremap <leader>cl :lua vim.lsp.codelens.run()<CR>
nnoremap <leader>gsd <cmd>lua vim.diagnostic.open_float(); vim.diagnostic.open_float()<CR>
nnoremap <leader>gdd <cmd>Telescope diagnostics<CR>
nnoremap <leader>gwd <cmd>Telescope diagnostics<CR>
nnoremap <leader>gfm <cmd>lua vim.lsp.buf.format { async = true}<CR>
nnoremap <leader>gss <cmd>lua require('telescope.builtin').lsp_document_symbols()<CR>
nnoremap <leader>gsw <cmd>lua require('telescope.builtin').lsp_workspace_symbols()<CR>
